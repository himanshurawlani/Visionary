...
public class ObjectAdapter extends ArrayAdapter<String> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        TextView confidence_text = listItemView.findViewById(R.id.confidence_text_view);
        ...
        TextView objectText = listItemView.findViewById(R.id.object_text_view);
        objectText.setText(class_count_confidence[0]);

        TextView frameText = listItemView.findViewById(R.id.frames_text_view);
